...
const CompleteProfile = () => {
  ...
  useEffect(() => {
    ...
    fetch(
      "https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyCBNqXOohJ5C1pTxxgYtTbpbxZc1ncW9fc",
      {
        method: "POST",
        body: JSON.stringify({
  ...
  const submitHandler = (e) => {
    ...
    if (enteredName === "" || enteredPhotoUrl === "") {
      ...
      return;
        ...
        fetch(
          "https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyCBNqXOohJ5C1pTxxgYtTbpbxZc1ncW9fc",
          {
            method: "POST",
            body: JSON.stringify({
              idToken: localStorage.getItem("token"),
